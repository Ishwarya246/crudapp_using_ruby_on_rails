...
class StudentInfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create student_info" do
    assert_difference("StudentInfo.count") do
      post student_infos_url, params: { student_info: { age: @student_info.age, email: @student_info.email, name: @student_info.name, rollno: @student_info.rollno } }
    end
  ...
  test "should update student_info" do
    patch student_info_url(@student_info), params: { student_info: { age: @student_info.age, email: @student_info.email, name: @student_info.name, rollno: @student_info.rollno } }
